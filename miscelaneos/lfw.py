...
def _load_imgs(file_paths, slice_, color, resize):
    ...
    try:
        try:
            from imageio import imread #originalmente estaba from scipy.misc import imread
        except ImportError:
            from scipy.misc.pilutil import imread
        from skimage.transform import resize as imresize #originalmente estaba scipy.misc import imresize
    except ImportError:
